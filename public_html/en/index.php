...
<section class="intro content-start">
    ...
    <div class="content_wrap intro-content">
        <div class="sec-title">
        <H3>Your connection between Mexico and the United States</H3>
        <h6>More than 15 years providing international services in our community</h6>
        </div>
        <div class="sec-items">
        <div class="img-item">
            <img src="<?php echo url_for('private\images\trad.jpg'); ?>" alt="">
            <div>
            <h5>Certified Translations</h5>
            <p>Translate your documents for your academic, judicial, administrative and immigration proceedings</p>
            </div>  
        </div>
        ...
        <div class="img-item">
            ...
            <p>If you need assistance obtaining your official document sin Mexico or the United States like Birth, Death, Marriage and other types of records, we can help, we can also help you make corrections. </p>
            </div>
        </div>
