...
<header> 
    <nav class="nav-main">
      ...
      <ul class="nav-links dark">
        <li><a href="<?php echo url_for('index.php?page=index') ?>">Home</a></li>
        <li><a href="<?php echo url_for('index.php?page=contact') ?>">Contact</a></li>
        <li><a href="<?php echo url_for('set_language.php?lan=es&page=' . $_GET['page']); ?>">Español</a></li>
      </ul>
      <div class="burger">
          <div class="line1"></div>
          <div class="line3"></div>
